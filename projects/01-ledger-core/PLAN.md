...
- 환경 변수로 주입한 합성 테스트 시크릿의 최소 Basic 인증; 키 저장·회전·역할 관리는 프로젝트 05로 이관

프로젝트 01의 필수 계약 ID는 `TP-PAY-001..003`, `TP-WIRE-001`, `TP-WIRE-003`, `TP-WIRE-005..006`, `TP-STATE-001`, `SBX-001`입니다. `TP-WIRE-002` 공개 멱등성은 프로젝트 02, `TP-WIRE-004` 버전 호환성은 프로젝트 07의 필수 종료 조건에서 검증합니다.
